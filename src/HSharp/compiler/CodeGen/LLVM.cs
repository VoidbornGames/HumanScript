...
internal static class LLVM
{
    ...
    [DllImport(Lib)] public static extern IntPtr LLVMBuildFPToSI(IntPtr builder, IntPtr value, IntPtr destType, string name);
    ...
    [DllImport(Lib)] public static extern IntPtr LLVMGetUndef(IntPtr type);
    [DllImport(Lib)] public static extern IntPtr LLVMBuildInsertValue(IntPtr builder, IntPtr agg, IntPtr elt, uint idx, string name);
    [DllImport(Lib)] public static extern IntPtr LLVMBuildExtractValue(IntPtr builder, IntPtr agg, uint idx, string name);
